...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        ltCorner = BitmapFactory.decodeResource(getResources(), R.drawable.lt_corner);
        rtCorner = BitmapFactory.decodeResource(getResources(), R.drawable.rt_corner);
        lbCorner = BitmapFactory.decodeResource(getResources(), R.drawable.lb_corner);
        rbCorner = BitmapFactory.decodeResource(getResources(), R.drawable.rb_corner);
    }
