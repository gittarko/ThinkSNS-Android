 ...
 */
public class ClassicEditPage extends EditPageFakeActivity implements OnClickListener, TextWatcher {
...
//		rlThumb.setId(1);
	...
	private LinearLayout getAtLine(String platform) {
		...
		llAt.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				ClassicFollowListPage subPage = new ClassicFollowListPage();
				subPage.setPlatform(platforms.get(0));
				subPage.showForResult(activity, null, ClassicEditPage.this);
			}
		});
