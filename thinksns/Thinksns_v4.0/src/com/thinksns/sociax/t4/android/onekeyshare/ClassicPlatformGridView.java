...
public class ClassicPlatformGridView extends LinearLayout implements
	...
	private ClassicPlatformListPage parent;
	private ArrayList<CustomerLogo> customers;
	private HashMap<String, String> hiddenPlatforms;
	private View bgView;
	private long lastClickTime;

	public ClassicPlatformGridView(Context context) {
		super(context);
		init(context);
	}

	public ClassicPlatformGridView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void init(final Context context) {
		...
		new Thread() {
			public void run() {
				...
				UIHandler.sendEmptyMessage(MSG_PLATFORM_LIST_GOT, ClassicPlatformGridView.this);
			}
		}.start();
	}
	...
	public void setParent(ClassicPlatformListPage parent) {
		this.parent = parent;
	}
	...
	private static class PlatformAdapter extends ViewPagerAdapter {
		...
		private int lines;
		private ClassicPlatformGridView platformGridView;

		public PlatformAdapter(ClassicPlatformGridView platformGridView) {
