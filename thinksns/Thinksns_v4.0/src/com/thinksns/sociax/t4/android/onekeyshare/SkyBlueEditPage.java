...
public class SkyBlueEditPage extends EditPageFakeActivity implements OnClickListener, TextWatcher {
			...
			if (isShowAtUserLayout(platformName)) {
				...
				OnClickListener atBtnClickListener = new OnClickListener() {
					public void onClick(View v) {
						SkyBlueFollowListPage subPage = new SkyBlueFollowListPage();
						subPage.setPlatform((Platform) v.getTag());
						subPage.showForResult(activity, null, SkyBlueEditPage.this);
					}
				};
