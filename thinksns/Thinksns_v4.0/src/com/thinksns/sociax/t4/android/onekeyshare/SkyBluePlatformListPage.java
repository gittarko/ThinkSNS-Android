...
public class SkyBluePlatformListPage extends PlatformListFakeActivity implements View.OnClickListener {
	private SkyBluePlatformGridViewAdapter gridViewAdapter;
	...
	private void initView() {
		...
		gridViewAdapter = new SkyBluePlatformGridViewAdapter(activity);
